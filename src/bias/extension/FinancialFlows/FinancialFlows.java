...
@AddOnAnnotation(version = "0.1.1", author = "R. Kasianenko", description = "Financial Flows Management & Statistics", details = "<i>FinancialFlows</i> extension for Bias is a part of standard \"all-inclusive-delivery-set\" of Bias application.<br>"
