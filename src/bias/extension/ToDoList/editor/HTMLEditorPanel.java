...
public class HTMLEditorPanel extends JPanel {
    ...
    private static final ImageIcon ICON_ENTRY_LINK = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/entry_link.png"));

    private static final ImageIcon ICON_URL_LINK = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/url_link.png"));

    private static final ImageIcon ICON_IMAGE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/image.png"));

    private static final ImageIcon ICON_COLOR = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/color.png"));

    private static final ImageIcon ICON_TEXT_UNDERLINE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/text_underlined.png"));

    private static final ImageIcon ICON_TEXT_ITALIC = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/text_italic.png"));

    private static final ImageIcon ICON_TEXT_BOLD = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/text_bold.png"));

    private static final ImageIcon ICON_SWITCH_MODE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/switch_mode.png")); // @jve:decl-index=0:

    private static final ImageIcon ICON_SAVE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/ToDoList/editor/save.png"));
