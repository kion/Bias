...
public class HTMLEditorPanel extends JPanel {
    ...
    private static final ImageIcon ICON_ENTRY_LINK = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/entry_link.png"));

    private static final ImageIcon ICON_URL_LINK = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/url_link.png"));

    private static final ImageIcon ICON_IMAGE = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/image.png"));

    private static final ImageIcon ICON_COLOR = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/color.png"));

    private static final ImageIcon ICON_TEXT_UNDERLINE = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/text_underlined.png"));

    private static final ImageIcon ICON_TEXT_ITALIC = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/text_italic.png"));

    private static final ImageIcon ICON_TEXT_BOLD = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/text_bold.png"));

    private static final ImageIcon ICON_SWITCH_MODE = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/switch_mode.png"));

    private static final ImageIcon ICON_SAVE = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/save.png"));

    private static final ImageIcon ICON_EDIT_CODE = new ImageIcon(CommonUtils.getResourceURL(ToDoList.class, "editor/edit_code.png"));
