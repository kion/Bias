 ...
 */
package bias.extension.DashBoard.frame.HTMLPageFrame;
...
import bias.extension.DashBoard.frame.HTMLPageFrame.editor.HTMLEditorPanel;

/**
 * @author kion
 */
public class HTMLPageFrame extends InternalFrame {
    private static final long serialVersionUID = 1L;

    private HTMLEditorPanel editorPanel;

    public HTMLPageFrame(UUID id, String content) {
        super(id, content);
    }
