...
public class HTMLEditorPanel extends JPanel {
    ...
    private static final ImageIcon ICON_ENTRY_LINK = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/entry_link.png"));

    private static final ImageIcon ICON_URL_LINK = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/url_link.png"));

    private static final ImageIcon ICON_IMAGE = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/image.png"));

    private static final ImageIcon ICON_COLOR = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/color.png"));

    private static final ImageIcon ICON_TEXT_UNDERLINE = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/text_underlined.png"));

    private static final ImageIcon ICON_TEXT_ITALIC = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/text_italic.png"));

    private static final ImageIcon ICON_TEXT_BOLD = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/text_bold.png"));

    private static final ImageIcon ICON_SWITCH_MODE = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/switch_mode.png"));

    private static final ImageIcon ICON_SAVE = new ImageIcon(BackEnd.getInstance().getResourceURL(DashBoard.class, "frames/HTMLPageFrame/editor/save.png"));
