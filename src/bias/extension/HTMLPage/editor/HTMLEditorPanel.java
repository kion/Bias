...
public class HTMLEditorPanel extends JPanel {
    ...
    private static final ImageIcon ICON_ENTRY_LINK = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/entry_link.png"));

    private static final ImageIcon ICON_URL_LINK = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/url_link.png"));

    private static final ImageIcon ICON_IMAGE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/image.png"));

    private static final ImageIcon ICON_COLOR = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/color.png"));

    private static final ImageIcon ICON_TEXT_UNDERLINE = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/text_underlined.png"));

    private static final ImageIcon ICON_TEXT_ITALIC = new ImageIcon(HTMLEditorPanel.class.getResource("/bias/res/HTMLPage/editor/text_italic.png"));
