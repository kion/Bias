...
public class CustomHTMLCodeDocument extends DefaultStyledDocument {
    ...
    public static final Color COLOR_EDITOR_BACKGROUND = new Color(60, 63, 65);

    private static final Color COLOR_TEXT_DEFAULT = new Color(227, 227, 227);

    private static final Color COLOR_HTML_TAG = new Color(170, 213, 255);

    private static final Color COLOR_HTML_ATTR = new Color(198, 255, 212);

    private static final Color COLOR_HTML_SPEC_CHAR = new Color(167, 226, 255);

    private static final Color COLOR_HTML_QUOTE = new Color(255, 155, 155);

    private static final Color COLOR_HTML_COMMENT = new Color(153, 153, 153);
    ...
    CustomHTMLCodeDocument(JTextPane editor) {
        this.editor = editor;
        this.editor.setBackground(COLOR_EDITOR_BACKGROUND);
        ...
        StyleConstants.setForeground(otherText, COLOR_TEXT_DEFAULT);
        ...
        StyleConstants.setForeground(HTMLTag, COLOR_HTML_TAG);
        StyleConstants.setBold(HTMLTag, true);
        attribute = new SimpleAttributeSet();
        StyleConstants.setForeground(attribute, COLOR_HTML_ATTR);
        StyleConstants.setBold(attribute, false);
        specChar = new SimpleAttributeSet();
        StyleConstants.setForeground(specChar, COLOR_HTML_SPEC_CHAR);
        StyleConstants.setBold(specChar, true);
        quote = new SimpleAttributeSet();
        StyleConstants.setForeground(quote, COLOR_HTML_QUOTE);
        StyleConstants.setBold(quote, false);
        comment = new SimpleAttributeSet();
        StyleConstants.setForeground(comment, COLOR_HTML_COMMENT);
